"""
Created on Sun Oct 16 16:07:18 2022
...
Xh1, Hist1 = CalculoG(x, Nhist, 1, L)
plt.figure(1)
plt.plot(Xh1, Hist1, '-')
'''
Xh2, Hist2 = CalculoG(x, Nhist, Nt//256, L)
plt.figure(2)
plt.plot(Xh2, Hist2, '-')

Xh3, Hist3 = CalculoG(x, Nhist, Nt//128, L)
plt.figure(3)
plt.plot(Xh3, Hist3, '-')
'''
Xh4, Hist4 = CalculoG(x, Nhist, Nt-1, L)
plt.figure(2)
plt.plot(Xh4, Hist4, '-')